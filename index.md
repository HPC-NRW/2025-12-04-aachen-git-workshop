...
address: "Seminarroom 003, Kopernikusstr. 6, 52074 Aachen"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "50.780785"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "6.065034"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Dec 4-5, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "09:00 am - 4:30 pm"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2025-12-04      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2025-12-05        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Marc-André Hermanns", "Jonathan Hartman", "Nicole Parks"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Martin Pieters", "Jannis Klinkenberg"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["hermanns@itc.rwth-aachen.de","hartman@itc.rwth-aachen.de"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.tools.coscine.dev/3r-kOgdMScqQu-PVd_IK7w  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite:           # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
what3words: "cocktail.overlook.affords"          # optional: what3words (https://what3words.com) address of the workshop venue, without leading slashes e.g. "globe.lessening.computers"
---
...
<strong>Note:</strong> You can now book the two workshop
days separately. The first day (Thursday) covers Git & Gitlab Basics and the second day
